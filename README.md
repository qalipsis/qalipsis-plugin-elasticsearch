...
![CI](https://github.com/qalipsis/qalipsis-plugin-elasticsearch/actions/workflows/gradle-master.yml/badge.svg)
...
The QALIPSIS plugin for Elasticsearch is distributed under the Apache License 2.0, the terms can be
read [here](./LICENSE).
